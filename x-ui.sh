...
update() {
    ...
    bash <(curl -Ls https://raw.githubusercontent.com/skvarovski/3x-ui/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_menu() {
    ...
    curl -fLRo /usr/bin/x-ui https://raw.githubusercontent.com/skvarovski/3x-ui/main/x-ui.sh
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/skvarovski/3x-ui/master/install.sh)${plain}"
    echo ""
...
update_shell() {
    curl -fLRo /usr/bin/x-ui -z /usr/bin/x-ui https://github.com/skvarovski/3x-ui/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
